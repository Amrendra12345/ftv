    ...
    <div className="search_country">
        <div className='origin_country'>
            <div className="ftv-field">
                ...
                <input type='text' id='origin' className='form-control'value={originInputValue || ''} placeholder="Select..." onClick={originClickHandler}  onChange={originChangekHandler} onKeyDown={handleKeyDown} />
            </div>
